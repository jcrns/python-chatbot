...
from data import format_all
from tensorlayer.models.seq2seq import Seq2seq
from tensorlayer.models.seq2seq_with_attention import Seq2seqLuongAttention
import os

# Setup function getting training variables
def initial_setup():
    metadata, idx_q, idx_a = format_all.load_data(PATH='data/')
    (trainX, trainY), (testX, testY), (validX, validY) = format_all.split_dataset(idx_q, idx_a)
...
seeds = ["how old are you?", "How are you",
